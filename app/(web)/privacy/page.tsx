    ...
    <div className="container @md:mt-30 mt-20 flex flex-col @md:gap-30 gap-20">
      <div className="mx-auto flex max-w-4xl flex-col gap-6">
        ...
        <ul className="list-inside list-disc space-y-2">
          ...
          <li>
            Occasionally analyze what content people interact with the most, to
            make our site and services better.
          </li>
        </ul>
        <p className="leading-relaxed tracking-tight">
        ...
        <p className="leading-relaxed tracking-tight">
          ...
          browser, but they don&apos;t give us access to anything personal like
          your name or email.
        </p>
        <p className="leading-relaxed tracking-tight">
          You can disable cookies in your browser settings if you prefer no hard
          feelings.
        </p>
